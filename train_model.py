...
def save_model(model, filename: str = "../models/gesture_model.pkl.gz"):
    # gzip压缩保存模型
    ...
    json_name = filename.replace(".pkl.gz", "_meta.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="../models/gesture_model.pkl.gz", help="输出文件名")
    args = parser.parse_args()
    
    X_train, X_test, y_train, y_test = load_data()
    best_model, all_results = train_and_compare(X_train, X_test, y_test)
